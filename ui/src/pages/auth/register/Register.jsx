...
const Register = () => {
  ...
  const [register, { isLoading, isSuccess, isError, error, reset }] =
    useRegisterMutation();
  const form = useForm({
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <div className="relative">
                            <User className="absolute left-3 top-2.5 h-5 w-5 text-muted-foreground z-10" />
                            <FormControl>
                              <Input
                                placeholder="John"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <div className="relative">
                          <Mail className="absolute left-3 top-2.5 h-5 w-5 text-muted-foreground z-10" />
                          <FormControl>
                            <Input
